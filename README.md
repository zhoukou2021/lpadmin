...
LPadmin是基于Laravel10 + Pearadmin Layui框架开发的现代化后台管理系统,支持前端多语言配置，提供完整的RBAC权限管理、用户管理、系统配置等功能。
- 开发案例
Lpadmin多语言博客系统：https://github.com/zhoukou2021/Lpadmin-Blog
- 效果展示
![后台首页](后台首页.png) ![系统配置](系统配置.png)
## ✨ 特性
