...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        // LPadmin middleware
        'lpadmin.auth' => \App\Http\Middleware\LPadminAuth::class,
        'lpadmin.permission' => \App\Http\Middleware\LPadminPermission::class,
        'lpadmin.log' => \App\Http\Middleware\LPadminLog::class,
